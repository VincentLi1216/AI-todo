...
from util_update_db import create_things_todo
...
class CreateTodoInput(BaseModel):
    ...
    project_title: str = Field(title=f"The title of the project, choose from {get_things_projects_names()}, if there's no suitable project, input ''")
...
''')
    ...
    def create_todo(self, title: str, notes: str, project_title: str):
        ...
        create_things_todo(title=title, notes = f"Auto Generated by 🛸Mindflow.ai\n{notes}" if notes == "" else f"{notes}\n\nAuto Generated by 🛸Mindflow.ai"
, list_name=project_title, show_quick_entry=True, tags="🛸AI")
        return f'New Todo Item Created: "{title}"'
